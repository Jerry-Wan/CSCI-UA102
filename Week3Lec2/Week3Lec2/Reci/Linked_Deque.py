...
class LinkedDeque:
    ...
    def add_first(self, e):
        ...
        # Your code
        a = self._Node(e,None,None)
        a._next = self._head._next
        a._prev = self._head
        self._head._next._prev = a
        self._head._next = a
        self._size += 1
    ...
    def add_last(self, e):
        ...
        a = self._Node(e,None,None)
        a._next = self._tail
        a._prev = self._tail._prev
        self._tail._prev._next = a
        self._tail._prev = a
        self._size += 1
