...
class Matrix :
    ...
    def max_value(self):
        ...
        for row in range( self._theGrid.numRows() ):
            for col in range(self._theGrid.numCols()):
                if self._theGrid[row, col] > maximum:
                    maximum = self[row, col]
        return maximum
    ...
    def scaleBy( self, scalar ):
        for row in range( self._theGrid.numRows() ):
            for col in range(self._theGrid.numCols()):
                self._theGrid[row, col] = self._theGrid[row, col]*scalar
    ...
    def transpose( self ):
        ...
        for row in range( self._theGrid.numRows() ):
            for col in range(self._theGrid.numCols()):
                a._theGrid[col, row] = self._theGrid[row, col]
        return a
    ...
    def __add__( self, rhsMatrix ):
        for row in range( self._theGrid.numRows() ):
            for col in range(self._theGrid.numCols()):
                self._theGrid[row, col] += rhsMatrix._theGrid[row, col]
        return self
        ...
        for row in range(self.numRows()):
            for col in range(rhsMatrix.numCols()):
                ...
                for b in range(self.numCols()):
                    num+= self[row,b]*rhsMatrix[b,col]
                a.__setitem__((row,col),num)
        return a
