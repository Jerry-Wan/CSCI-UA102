class SingleLinkedList:
    ...
    def list_reverse(self):
        ...
        while current!= None:
            ...
            current = current._next
        for a in range(self._size - 1, -1, -1):
            if a == 0:
                element[0]._next = None
            else:
                element[a]._next = element[a - 1]
        self._head = element[self._size - 1]
    ...
    def remove_all_occurance(self, value):
        ...
        while current._next != None:
            if  current._next._element == value:
                ...
                current = current._next
        if self._size ==1 and self._head._element ==value:
            self._head = None
            return self
        else:
            return self
