...
def LevelOrderTraversal(tree, root = 0):
    if tree == None:
        return
    if root == 0:
        print(tree._element, end = " ")
    if tree._left != None:
        print(tree._left, end = " ")
    if tree._right != None:
        print(tree._right, end = " ")
    LevelOrderTraversal(tree._left,root+1)
    LevelOrderTraversal(tree._right,root+1)
